...
Scenario: when a user increases a counter three times, it is increased by 3

Given a counter
And the counter has any integral value
When the user increases the counter
And the user increases the counter
And the user increases the counter
Then the value of the counter must be 3 greater than previous value